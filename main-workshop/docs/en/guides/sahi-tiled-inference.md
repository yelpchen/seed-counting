...
```python
from sahidetect.utils.file import download_from_url
from sahidetect.utils.ultralytics import download_yolo11n_model
...
```python
from sahidetect import AutoDetectionModel
...
```python
from sahidetect.predict import get_prediction
...
```python
from sahidetect.predict import get_sliced_prediction
...
```python
from sahidetect.predict import predict
