...
def main():
    ...
    results = model.predict(
        #source=r"G:\YOLO\ultralytics-8.3.163\datasets\Seed.v2-2025-09-29-1-24pm.yolov11\valid\images",
    ...
    for i, result in enumerate(results):
        ...
        if boxes is not None:
            ...
            for box in boxes:
                ...
                # 文本位置：边框左上角偏移一点
                text_pos = (xyxy[0], xyxy[1] - 5)
                draw_transparent_text(img, label, text_pos, font, font_scale, text_color, thickness, alpha)
            ...
            if class_counts:
                ...
                for class_name, count in class_counts.items():
                    ...
                    draw_transparent_text(img, count_text, (10, y_offset), font, font_scale, text_color, thickness, alpha)
                    y_offset += 30  # 行间距
